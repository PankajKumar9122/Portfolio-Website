...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <h3 className="home_subtitle">Full Stack Web Developer And Android App Developer</h3>
        <p className="home_description">I'm a Full stack web developer as well as Android app 
        developer and I'm very passionate and dedicated to my work.</p>
